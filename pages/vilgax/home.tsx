...
import stylesMain from '../../styles/vilgax/Home.module.scss';
...
export default function VilgaxHome () {
  ...
  return (
    <> 
      ...
      <div id="containerMain" className={stylesMain.containerVilgaxMain}>
          <main className={'main'}>
            <Image priority src="/jvk_vilgax.gif" alt="JvkScript_Vilgax" width={300} height={310} loading="eager"/>
