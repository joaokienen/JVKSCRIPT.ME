...
import stylesMain from '../../styles/aurora/Home.module.scss';
...
export default function AuroraHome () {
  ...
  return (
    <> 
      ...
      <div id="containerMain" className={stylesMain.containerAuroraMain}>
          <main className={'main'}>
            <Image priority src="/jvk_aurora.gif" alt="JvkScript_Aurora" width={300} height={310} loading="eager"/>
