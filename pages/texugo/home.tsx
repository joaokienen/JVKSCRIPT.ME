...
import stylesMain from '../../styles/texugo/Home.module.scss';
...
export default function TexugoHome () {
  ...
  return (
    <> 
      ...
      <div id="containerMain" className={stylesMain.containerTexugoMain}>
          <main className={'main'}>
            <Image priority src="/jvk_texugo.gif" alt="JvkScript_Texugo" width={300} height={310} loading="eager"/>
