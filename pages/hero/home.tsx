...
import stylesMain from '../../styles/hero/Home.module.scss';
...
export default function HeroHome () {
  ...
  return (
    <> 
      ...
      <div id="containerMain" className={stylesMain.containerHeroMain}>
          <main className={'main'}>
            <Image priority src="/jvk_hero.gif" alt="JvkScript_Hero" width={300} height={310} loading="eager"/>
