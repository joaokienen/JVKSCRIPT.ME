...
const BodyHero = dynamic(() => import('../../components/hero/bodymain'), {
  suspense: true,
})
        ...
        <style jsx global> {globalStyles} </style>
          ...
          <div id='container' className={"container"}>
            ...
            <div id="fakeScr0" className={"fakeScr0"}>
              ...
              <p id="cursorZipo01" className={styles.line01}>&gt; start ./Hero<span className={styles.cursor01}>_</span></p>
              
              <div id="fakeScr00" className={"fakeScr00"}>
                <p id="cursorHero" className={styles.line1}>$ Hero<span className={styles.cursor1}>_</span></p>
