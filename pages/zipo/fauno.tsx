...
const BodyFauno = dynamic(() => import('../../components/fauno/bodymain'), {
  suspense: true,
})

export default function Fauno () {
        ...
        <style jsx global> {globalStyles} </style>
          ...
          <div id='container' className={"container"}>
            ...
            <div id="fakeScr0" className={"fakeScr0"}>
              ...
              <p id="cursorZipo01" className={styles.line01}>&gt; start ./Fauno<span className={styles.cursor01}>_</span></p>
              
              <div id="fakeScr00" className={"fakeScr00"}>
                <p id="cursorFauno" className={styles.line1}>$ Fauno<span className={styles.cursor1}>_</span></p>
