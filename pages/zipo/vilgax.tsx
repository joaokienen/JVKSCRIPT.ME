...
const BodyVilgax = dynamic(() => import('../../components/vilgax/bodymain'), {
  suspense: true,
})

export default function Vilgax () {
          ...
          <style jsx global> {globalStyles} </style>
            ...
            <div id='container' className={"container"}>
              ...
              <div id="fakeScr0" className={"fakeScr0"}>
                ...
                <p id="cursorZipo01" className={styles.line01}>&gt; start ./Vilgax<span className={styles.cursor01}>_</span></p>
                
                <div id="fakeScr00" className={"fakeScr00"}>
                  <p id="cursorVilgax" className={styles.line1}>$ Vilgax<span className={styles.cursor1}>_</span></p>
