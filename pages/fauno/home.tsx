...
import stylesMain from '../../styles/fauno/Home.module.scss';
import Image from 'next/image';
import { stealth, journy, coder, karm } from '../../components/home/consts';
...
export default function FaunoHome () {
  ...
  return (
    <> 
      ...
      <div id="containerMain" className={stylesMain.containerFaunoMain}>
          <main className={'main'}>
            <Image priority src="/jvk_fauno.gif" alt="JvkScript_Fauno" width={300} height={310} loading="eager"/>
